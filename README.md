...
面向约 20 名学生的在线 Excel 填写系统。学生分别扫描“破、扩、筛”三个固定二维码，在网页中填写原 Excel 工作表对应区域；教师按学号查看三阶段完成情况，并可下载单个学生或全班的 Excel。

## 已实现

- 三个固定学生入口：`/student/po`、`/student/kuo`、`/student/shai`
...
- 当前模板区域：破（第 5–14 行）、扩（第 16–26 行）、筛（第 28–40 行）。
